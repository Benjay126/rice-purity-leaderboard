        ...
        <form id='form' name='form' method="post">
            <div>
                ...
                <div>
                    ...
                    <input type="text" pattern="\d*" maxlength="1" id='id-pin-3' name='pin-3' oninput='joinPin(3, "id"); shiftFocus(1, "user")'>
            ...
            <div>
                ...
                <div>
                    ...
                    <input type="text" pattern="\d*" maxlength="1" id='user-pin-4' name='pin-4' oninput='joinPin(4, "user"); shiftFocus(1, "admin")'>
            ...
            <div>
                ...
                <div>
                    ...
                    <input type="text" pattern="\d*" maxlength="1" id='admin-pin-4' name='pin-4' oninput='joinPin(4, "admin"); submitForm()'>
...
<?php
    if(isset($_POST['btnSubmit'])) {
        ...
        $unique_user_sql = "SELECT * FROM users WHERE name='".$_POST['total-id-pin']."'";
